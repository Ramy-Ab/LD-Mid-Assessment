...
// import { CgExtensionAdd } from "react-icons/all";
...
export default function DrawerList() {
  ...
  const listeItems = [
    ...
    { icon: <ShoppingCart size={20} />, text: "Catalogue" },
    { icon: <FormatListBulleted sx={{ fontSize: 20 }} />, text: "Orders" },
    { icon: <PersonOutline sx={{ fontSize: 20 }} />, text: "Customers" },
    { icon: <Target size={20} />, text: "Marketing" },
    { icon: <Truck size={20} />, text: "Delivery options" },
    { icon: <DollarSign size={20} />, text: "Payment Options" },
    { icon: <Brush sx={{ fontSize: 20 }} />, text: "Store Design" },
    { icon: <CreditCard size={20} />, text: "Subscriptons" },
    {
      icon: (
        <svg
          width="20"
    ...
    // { icon: <CgExtensionAdd />, text: "Extensions" },
    { icon: <Settings />, text: "Settings" },
    { icon: <LogOut />, text: "Log out" },
  ];

  const listeItems2 = [
    { icon: <HelpCircle size={20} />, text: "Customer Support" },
    { icon: <Share2 size={20} />, text: "Share your shop" },
    { icon: <Eye size={2} />, text: "View your shop" },
  ];
